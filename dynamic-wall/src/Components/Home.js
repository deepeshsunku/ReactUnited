...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    var cards = [
      ...
      {type: "ShareCard", color: '#F85614', postedBy: 'SIKKA', posterImgUrl: sikkaPosterImgUrl, postedBy: 'SIKKA', timestamp: '20 DECEMBER 2017', url: 'http://www.dentalproductsreport.com/dental/article/latest-trends-dental-practice-accounts-receivable', title: 'Accounts Receivable', ctaTitle: 'Learn More'},
      ...
      {type: "ShareCard", color: '#2071B3', postedBy: 'SIKKA', posterImgUrl: sikkaPosterImgUrl, postedBy: 'SIKKA', timestamp: 'TODAY', url: 'https://store.sikkasoft.com/pa', title: 'Practice Assistant', ctaTitle: 'Learn more at the Sikka Marketplace'},
      ...
      {type: "ShareCard", color: '#EF3D3C', postedBy: 'SIKKA', posterImgUrl: sikkaPosterImgUrl, postedBy: 'SIKKA', timestamp: '30 DECEMBER 2017', url: 'https://blog.intercom.com/why-cards-are-the-future-of-the-web/', title: 'Cards', ctaTitle: 'Learn More'},
      {type: "ShareCard", color: '#3674FF', postedBy: 'SIKKA', posterImgUrl: sikkaPosterImgUrl, postedBy: 'SIKKA', timestamp: '2 JANUARY 2018', url: 'https://techcrunch.com/2017/10/11/amazon-alexa-devices-can-finally-distinguish-between-different-voices/', title: 'Alexa', ctaTitle: 'Learn More'},
      ...
      {type: "ShareCard", color: '#681c9a', postedBy: 'SIKKA', posterImgUrl: sikkaPosterImgUrl, postedBy: 'SIKKA', timestamp: '22 DECEMBER 2017', url: 'https://techcrunch.com/2017/12/31/voice-interfaces-beginning-to-find-their-way-into-business/', title: 'Voice Interfaces', ctaTitle: 'Learn More'},
      {type: "ShareCard", color: '#FF4081', postedBy: 'SIKKA', posterImgUrl: sikkaPosterImgUrl, postedBy: 'SIKKA', timestamp: '20 DECEMBER 2017', url: 'https://newsroom.cnb.com/6-tips-to-improve-your-accounts-receivable-collections', title: 'Accounts Receivable', ctaTitle: 'Learn More'},
      {type: "ShareCard", color: '#174D8B', postedBy: 'SIKKA', posterImgUrl: sikkaPosterImgUrl, postedBy: 'SIKKA', timestamp: 'TODAY', url: 'https://store.sikkasoft.com/ICSystem', title: 'IC System', ctaTitle: 'Learn more at the Sikka Marketplace', imgUrl: 'https://marketplaceportal.s3.amazonaws.com/201712072204032930.png', description: 'IC System’s Dental Debt Collection services will bring more revenue into your office while preserving your sensitive patient relationships. Our Dental Debt Collection services ensure that your staff saves time from having to recover patient debts. Whether you’re part of a large clinic or a single-dentist practice, our products will meet your needs, allowing you to focus on what’s important: your patients.'},
      ...
      {type: "TwoColumn", color: '#2071B3', name: "Daily Average Net Production", requestType: "daily%20average%20net%20production", startDate: yesterday, endDate: yesterday},
      {type: "TwoColumn", color: '#2071B3', name: "Morning Report", requestType: "morning%20report", startDate: yesterday, endDate: yesterday},
      {type: "TwoColumn", color: '#2071B3', name: "Insurance Claims", requestType: "Insurance%20Claims", startDate: moment().subtract(31, 'days').format('YYYY-MM-DD'), endDate: today},
      {type: "TwoColumn", color: '#2071B3', name: "Top 20 Procedures by Production", requestType: "Top%2020%20Procedures%20by%20Production", startDate: moment().subtract(31, 'days').format('YYYY-MM-DD'), endDate: today},
      {type: "TwoColumn", color: '#2071B3', name: "Insurance Claims Pending", requestType: "Insurance%20Claims%20Pending", startDate: today, endDate: today},
