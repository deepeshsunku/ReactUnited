...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    var cards = [
      ...
      {type: "RadialChartCard", color: '#2071B3', postedOn: moment().subtract(1, 'days'), name: "Daily Average Gross Production", requestType: "daily%20average%20gross%20production", timestamp: 'TODAY', startDate: moment().subtract(2, 'days').format('YYYY-MM-DD'), endDate: moment().subtract(2, 'days').format('YYYY-MM-DD')},
      {type: "RadialChartCard", color: '#2071B3', postedOn: moment().subtract(3, 'days'), name: "Daily Average Net Production", requestType: "daily%20average%20net%20production", timestamp: 'TODAY', startDate: moment().subtract(2, 'days').format('YYYY-MM-DD'), endDate: moment().subtract(2, 'days').format('YYYY-MM-DD')},
      {type: "RadialChartCard", color: '#2071B3', postedOn: moment().subtract(4, 'days'), name: "Insurance Claims Pending", requestType: "Insurance%20Claims%20Pending", timestamp: 'TODAY', startDate: yesterday, endDate: yesterday},
      ...
      {type: "RadialChartCard", color: '#2071B3', postedOn: moment().subtract(7, 'hours'), name: "Accounts Receivable", requestType: "Accounts%20Receivable", timestamp: 'TODAY', startDate: today, endDate: today},
