...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    var cards = [,
      ...
      {type: "RadialChartCard", color: '#2071B3', name: "Daily Average Gross Production", requestType: "daily%20average%20gross%20production", timestamp: 'TODAY', startDate: yesterday, endDate: yesterday},
      {type: "RadialChartCard", color: '#2071B3', name: "Daily Average Net Production", requestType: "daily%20average%20net%20production", timestamp: 'TODAY', startDate: yesterday, endDate: yesterday},
      {type: "RadialChartCard", color: '#2071B3', name: "Insurance Claims Pending", requestType: "Insurance%20Claims%20Pending", timestamp: 'TODAY', startDate: yesterday, endDate: yesterday},
